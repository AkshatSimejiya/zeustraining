...
//      */
//     selectRow(row, preserveExisting = false, multiple = false) {
//         if (!preserveExisting) {
//             this.clearAllSelections();
//         }
...
//         const selection = {
//             startRow: 0,
//             endRow: this.maxRows - 1, // Use practical maximum instead of MAX_SAFE_INTEGER
//             startCol: col,
//             endCol: col,
//             activeRow: 0,
//             activeCol: col,
...
export class Selection {
    ...
    selectColumn(col, preserveExisting = false, shift = false) {
        ...
        this.selections.push(selection);
        this.lastColSelection = col; // Remember this column for future shift-clicks
        console.log(this.lastColSelection)
        this.triggerCallback('onSelectionChange', this.selections);
        return selection;
    }
